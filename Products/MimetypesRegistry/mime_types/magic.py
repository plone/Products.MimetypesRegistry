...
magic = [
    ...
    [0L, 'string', '=', '\177ELF', 'application/x-executable'],
    ...
    [0L, 'string', '=', 'DCMw', 'application/dicom'],
    [0L, 'string', '=', 'gimp xcf', 'image/x-xcf'],
    ...
    [0L, 'belong', '=', '0x53445058', 'image/dpx'],
    ...
    [0L, 'string', '=', '<!DOCTYPE svg', 'image/svg+xml'],
    [0L, 'string', '=', '<svg', 'image/svg+xml'],
    [0L, 'string', '=', '<?php', 'application/x-php'],
    [0L, 'string', '=', '<smil\>', 'application/smil'],
    [0L, 'string', '=', '<SMIL\>', 'application/smil'],
    ...
    [0L, 'string', '=', '#!/bin/ksh', 'application/x-shellscript'],
    [0L, 'string', '=', '#!/bin/perl', 'text/x-perl'],
    [0L, 'string', '=', '#!/bin/zsh', 'application/x-shellscript'],
    [1L, 'string', '=', '/bin/sh', 'text/x-sh'],
    [1L, 'string', '=', '/bin/bash', 'text/x-sh'],
    [1L, 'string', '=', '/bin/csh', 'text/x-csh'],
    [1L, 'string', '=', '/bin/ksh', 'application/x-shellscript'],
    ...
    [0L, 'string', '=', '.ra\375', 'audio/vnd.rn-realaudio'],
    [0L, 'belong', '=', '0x2e7261fd', 'audio/vnd.rn-realaudio'],
    ...
    [0L, 'string', '=', 'pnm:\/\/', 'audio/vnd.rn-realaudio'],
    [0L, 'string', '=', 'rtsp:\/\/', 'audio/vnd.rn-realaudio'],
    [0L, 'string', '=', 'SIT!', 'application/x-stuffit'],
    [0L, 'string', '=', '\312\376\272\276', 'application/x-java'],
    [0L, 'string', '=', 'Joy!', 'application/x-pef-executable'],
    [4L, 'string', '=', '\x11\xAF', 'video/x-flic'],
    [4L, 'string', '=', '\x12\xAF', 'video/x-flic'],
    ...
    [32769L, 'string', '=', 'CD001', 'application/x-cd-image'],
    [37633L, 'string', '=', 'CD001', 'application/x-cd-image'],
    [32776L, 'string', '=', 'CDROM', 'application/x-cd-image'],
