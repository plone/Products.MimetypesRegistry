...
magic = [
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.writer",
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.calc",
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.draw",
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.impress",
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.chart",
    ...
    [
        ...
        "string",
        "=",
        b"mimetypeapplication/vnd.sun.xml.global",
    ...
    [11, "string", "=", b"must be converted with BinHex", "application/mac-binhex40"],
    ...
    [
        ...
        "string",
        "=",
        rb"8BPS  \000\000\000\000 &0xffffffff0000ffffffff",
        "image/x-psd",
    ],
    ...
    [
        ...
        "string",
        "=",
        rb"<!DOCTYPE NETSCAPE-Bookmark-file-1\>",
    ...
    [0, "string", "=", rb"<\!DOCTYPE abiword", "application/x-abiword"],
    ...
    [0, "string", "=", rb"pnm://", "audio/vnd.rn-realaudio"],
    [0, "string", "=", rb"rtsp://", "audio/vnd.rn-realaudio"],
    ...
    [0, "string", "=", b"Microsoft Excel 5.0 Worksheet", "application/vnd.ms-excel"],
    [0, "string", "=", b"Biff5", "application/vnd.ms-excel"],
    [0, "string", "=", b"*BEGIN SPREADSHEETS    ", "application/x-applix-spreadsheet"],
    [0, "string", "=", b"*BEGIN SPREADSHEETS    ", "application/x-applix-spreadsheet"],
    ...
    [0, "string", "=", rb"\<MakerScreenFont", "application/x-font-framemaker"],
